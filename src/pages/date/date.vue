<template>
	<div>
		<!-- 头部标题 -->
		<Header title="日期餐别"></Header>
		<!-- 主体部分 -->
		<div class="pl-3 pr-3 mb-3 pt-2">
			<p><i>配送地址：<i class="text-danger">杨颖滨大楼3楼某某科301病房1号床位</i></i></p>
			<p><i>消费场所：<i class="text-danger">{{lctnName}}--{{areaName}}</i></i></p>
			<p><i>订餐类型：<i class="text-danger">病患营养餐</i></i></p>
			<!-- 选择 -->
			<div>
				<div class="time">
